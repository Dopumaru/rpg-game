...
const ENEMY_ART = {
  ...
  funayurei: {   // silhueta de fantasma, paleta esverdeada de afogado
    pal: { O: '#0a1c22', P: '#2e6b62', p: '#66aa96', W: '#eafff5', E: '#0a1c22', H: '#123028' },
    rows: [
      '................',
      '....HHHHHHHH....',
      '...HHHHHHHHHH...',
  ...
  isonade: {     // silhueta de harpia, paleta azul-tubarão
    pal: { O: '#0a1c24', B: '#2a5468', b: '#4a86a0', S: '#c8dce8', Y: '#88c8e0', R: '#3ab8ff', W: '#ffffff', H: '#0a1c24' },
    rows: [
      '................',
      '......HHHH......',
      '.....HbbbbH.....',
  ...
  umibozu: {     // silhueta de slime, paleta noturna de mar profundo
    pal: { O: '#050a14', G: '#16324a', g: '#2c5878', W: '#dff0ff', E: '#050a14' },
    rows: [
      '................',
      '................',
      '................',
  ...
  hyosube: {     // silhueta de goblin, paleta de pêlo enlameado
    pal: { O: '#1a1208', G: '#6b4a2a', g: '#9a7040', B: '#4a3a1c', W: '#fff0d0', E: '#1a1208', Y: '#c8b878' },
    rows: [
      '................',
      '.....OOOOOO.....',
      '....OBBBBBBO....',
  ...
  ushioni: {     // silhueta de orc, paleta de touro-demônio
    pal: { O: '#160406', G: '#6e1a18', g: '#9e2e28', B: '#1a1a1a', W: '#ffe8d0', E: '#160406', Y: '#3a3a3a' },
    rows: [
      '................',
      '..Y..OOOOOO..Y..',
      '..YOOGGGGGGOOY..',
  ...
  tesso: {       // silhueta de goblin, paleta de rato-de-ferro
    pal: { O: '#161414', G: '#5a5a62', g: '#8a8a92', B: '#3a3a40', W: '#f0f0f5', E: '#161414', Y: '#ff3a3a' },
    rows: [
      '................',
      '.....OOOOOO.....',
      '....OBBBBBBO....',
  ...
  yamabiko: {    // silhueta de harpia, paleta de eco espectral
    pal: { O: '#0e1428', B: '#4a5a9a', b: '#8a9ae0', S: '#dce4ff', Y: '#c0d0ff', R: '#ffffff', W: '#ffffff', H: '#0e1428' },
    rows: [
      '................',
      '......HHHH......',
      '.....HbbbbH.....',
  ...
  kijo: {        // silhueta de orc, paleta de oni-mulher da montanha
    pal: { O: '#1a0620', G: '#7a2a6a', g: '#b050a0', B: '#2a1a2a', W: '#ffe8f8', E: '#1a0620', Y: '#e8a0e0' },
    rows: [
      '................',
      '..Y..OOOOOO..Y..',
      '..YOOGGGGGGOOY..',
